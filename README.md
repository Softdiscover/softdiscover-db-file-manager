[![Contributors](https://img.shields.io/github/contributors/Softdiscover/softdiscover-db-file-manager.svg?style=flat-square)](https://github.com/Softdiscover/softdiscover-db-file-manager/graphs/contributors)  
[![Forks](https://img.shields.io/github/forks/Softdiscover/softdiscover-db-file-manager.svg?style=flat-square)](https://github.com/Softdiscover/softdiscover-db-file-manager/network/members)  
[![Stargazers](https://img.shields.io/github/stars/Softdiscover/softdiscover-db-file-manager.svg?style=flat-square)](https://github.com/Softdiscover/softdiscover-db-file-manager/stargazers)  
[![Issues](https://img.shields.io/github/issues/Softdiscover/softdiscover-db-file-manager.svg?style=flat-square)](https://github.com/Softdiscover/softdiscover-db-file-manager/issues)  
[![MIT License](https://img.shields.io/github/license/Softdiscover/softdiscover-db-file-manager.svg?style=flat-square)](https://github.com/Softdiscover/softdiscover-db-file-manager/blob/master/LICENSE.txt)  
[![LinkedIn](https://img.shields.io/badge/-LinkedIn-black.svg?style=flat-square&logo=linkedin&colorB=555)](https://www.linkedin.com/company/softdiscover)

  
 

 [![Logo](_images/logo.jpg)](https://github.com/Softdiscover/softdiscover-db-file-manager) 

### Managefy

ADVANCED DATABASE , BACKUP AND FILE MANAGER FOR WORDPRESS   
[**Explore the docs »**](https://github.com/Softdiscover/softdiscover-db-file-manager)   
  
[View Demo](https://github.com/Softdiscover/softdiscover-db-file-manager) · [Report Bug](https://github.com/Softdiscover/softdiscover-db-file-manager/issues) · [Request Feature](https://github.com/Softdiscover/softdiscover-db-file-manager/issues)
...
[![File Manager](_images/managefy-editcode-max.gif)](https://softdiscover.com)  
[![File Manager](_images/screenshot1.png)](https://softdiscover.com)

### Backup manager

[![Backup Manager](_images/managefy-backup-files.gif)](https://softdiscover.com)  
[![Backup Manager](_images/screenshot2.png)](https://softdiscover.com)

### User roles manager

[![User roles manager](_images/screenshot3.png)](https://softdiscover.com)
...
*   File Chunking Support (Upload Files larger than upload\_max\_size).
*   Icons and List View.
*   File Path Hider.
...
The latest version of Managefy ZIP file can be [**downloaded**](https://github.com/Softdiscover/softdiscover-db-file-manager/zipball/master) from https://github.com/Softdiscover/softdiscover-db-file-manager
...
4.  Click Browse and locate the file that you downloaded and click _Install Now_
5.  After Wordpress has finished unpacking the file click on _Activate Plugin_
