...
JS;
    ...
    public function get_menu(){
        ...
        switch ($current_page) 
		{
                case 'flmbkp_file_manager': $this->route_page(); break;
                ...
                case 'flmbkp_page_settings':
                    ...
                    exit;
                    break;
                case 'zigaform-builder-about':	include(dirname(__DIR__) . '/views/help/about.php');			break; 
                case 'zigaform-builder-debug':	include(dirname(__DIR__) . '/views/help/debug.php');			break;
                case 'zigaform-builder-gopro':	include(dirname(__DIR__) . '/views/help/gopro.php');			break;
                default:
                    break;
                }
    }
